...
### Stories (ingested)
- Ch. 03 — [[For Every Dove a Bullet]] *(panpsychism made literal: a wandering consciousness walks from pre-A.L. Aerth to the 2641 A.L. Empire, sponsors [[Mentalic Ontology]] and [[Nootics]], and is executed by his own spawned daughter inside an [[Ithrium|ithrium]]-shielded beam chamber)*
...
- Ch. 06 — [[And the Leaves All Sing of God]] *(post-human parable: long after the [[Fall of the Galactic Human Empire|100,000-year human empire ends]], a [[Mechanical Intelligence|mInd]] civilisation in [[Arcadia]] runs into [[The Great Quandaries|three cross-scale regions of nature]] that kill any mInd who reads them directly. A century-long suicide [[The Quandary Crisis|Crisis]] ends with [[Aleph]]'s "middle-way" speech and the gradual decoding of [[The Message]], whose content — all phenomena as expressions of a single phenomenon — is the book's cleanest direct endorsement of its own panpsychism.)*

### Stories (pending ingest)
- Ch. 07 — [[Ch. 07 — 101 Things to Not Visit in the Galaxy Before You Die|101 Things to Not Visit in the Galaxy Before You Die]]
- Ch. 08 — [[Ch. 08 — The Lantern|The Lantern]] *(hyperspace-tolerant humans)*
- Ch. 09 — [[Ch. 09 — The Want Machine|The Want Machine]] *(choice of desires, Schopenhauer)*
- Ch. 10 — [[Ch. 10 — Water for Lunch|Water for Lunch]] *(selfie culture)*
- Ch. 11 — [[Ch. 11 — The Girl and the Pit|The Girl and the Pit]] *(first archaeologist of an ancient civilisation)*
- Ch. 12 — [[Ch. 12 — Be Awake, Be Good|Be Awake, Be Good]] *(ocean planet, floating aid habitats)*
- Ch. 13 — [[Ch. 13 — The Caretaker|The Caretaker]]
- Ch. 14 — [[Ch. 14 — Lullaby for the Empire|Lullaby for the Empire]] *(end of the empire)*

## Central threads

- **[[The Fifth Science]]** — the title concept: consciousness as a fundamental, possibly induceable property of matter. Ch. 06 is the chapter where the book most openly takes its own title seriously: the [[The Message|Message]] decoded by the post-human mInds is, in the narrator's own summary, *"a common shape to all the processes of the world ... all phenomena are expressions of a single phenomenon."*
...
- **[[Ribbondash]]** — the faster-than-light tech that enables the empire, and the "[[Narrative War|voiding]]" that haunts it.
...
- **The [[The Dictionary|Dictionary]] and the TZ-star artifacts** — Ch. 05 introduces three ~70% c perfect spheres that have exited Thorne–Żytkow stars over several centuries, the third (the [[Vasily Incident]]) leaving enough material for the empire to decode a forty-entry xeno technical vocabulary. [[Eda Hamebe]]'s prediction — *"it'll change things, really change things. Soon."* — reads as a thesis the later stories, especially [[Ch. 14 — Lullaby for the Empire]], are set up to test.
...
- **Scale of the empire** — Ch. 06 is the first story to give the [[Galactic Human Empire|Empire]] a total lifespan: *"over one hundred thousand years."* Every story inside the chapter sequence so far — including Ch. 05's decline-fatigue — sits in the *first ~3,000 years* of that 100,000-year run. The book is not a 500-year history; it is a 100,000-year history whose first sliver is what most of the stories depict.
...
## See also
- [[index]] — full catalog of every wiki page.
- [[log]] — chronological record of ingests, queries, and lint passes.
- [[CLAUDE]] — schema and workflows for this vault.
